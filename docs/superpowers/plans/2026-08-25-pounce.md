# Pounce for macOS Implementation Plan
...
**Spec:** `pounce/docs/superpowers/specs/2026-08-25-pounce-design.md`
...
pounce/
  ...
  PounceTests/
    ...
    PounceWindowControllerTests.swift
```

## Task 1: Create the native macOS app target and domain vocabulary

**Files:**
- Create: `pounce/Pounce.xcodeproj` and app target using the Xcode macOS App template
- Create: `pounce/Pounce/PounceApp.swift`
- Create: `pounce/Pounce/Domain/CatActivity.swift`
- Create: `pounce/Pounce/Domain/CatPersonality.swift`
- Create: `pounce/Pounce/Domain/CatMood.swift`
- Create: `pounce/PounceTests/CatActivityTests.swift`

**Interfaces:**
- Produces: `CatActivity`, `CatPersonality`, and `CatMood` types consumed by every later domain and presentation task.

- [ ] **Step 1: Create an Xcode macOS App target named `Pounce`**

Set deployment target to macOS 14.0, interface to SwiftUI, language to Swift, and create the `PounceTests` XCTest target. Place all files under `pounce/`.
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatActivityTests`
...
```bash
git add pounce/Pounce.xcodeproj pounce/Pounce pounce/PounceTests/CatActivityTests.swift
...
**Files:**
- Create: `pounce/Pounce/Domain/CatScheduler.swift`
- Create: `pounce/PounceTests/CatSchedulerTests.swift`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatSchedulerTests`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS'`
...
```bash
git add pounce/Pounce/Domain/CatScheduler.swift pounce/PounceTests/CatSchedulerTests.swift
...
**Files:**
- Create: `pounce/Pounce/Domain/CatInteraction.swift`
- Create: `pounce/PounceTests/CatInteractionTests.swift`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatInteractionTests`
...
```bash
git add pounce/Pounce/Domain/CatInteraction.swift pounce/PounceTests/CatInteractionTests.swift
...
**Files:**
- Create: `pounce/Pounce/Domain/PetState.swift`
- Create: `pounce/Pounce/Persistence/PetStateStore.swift`
- Create: `pounce/PounceTests/PetStateStoreTests.swift`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/PetStateStoreTests`
...
```bash
git add pounce/Pounce/Domain/PetState.swift pounce/Pounce/Persistence/PetStateStore.swift pounce/PounceTests/PetStateStoreTests.swift
...
**Files:**
- Create: `pounce/Pounce/Desktop/PounceWindowController.swift`
- Create: `pounce/Pounce/Desktop/WorkspaceObserver.swift`
- Create: `pounce/PounceTests/PounceWindowControllerTests.swift`

**Interfaces:**
- Consumes: `PetState`.
- Produces: `PounceWindowController.setClickThrough(_:)`, `setVisible(_:)`, `moveToVisibleFrame(_:)`, `WorkspaceObserver.isFullscreenAppActive`.
...
func testPositionIsClampedInsideVisibleFrame() {
    ...
    let result = PounceWindowController.clampedOrigin(CGPoint(x: 1200, y: -50), windowSize: CGSize(width: 180, height: 180), visibleFrame: frame)
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/PounceWindowControllerTests`

Expected: failure because `PounceWindowController` is undefined.

- [ ] **Step 3: Implement the AppKit bridge**

```swift
final class PounceWindowController: NSWindowController {
...
```bash
git add pounce/Pounce/Desktop pounce/PounceTests/PounceWindowControllerTests.swift
...
**Files:**
- Create: `pounce/Pounce/Presentation/CatViewModel.swift`
- Create: `pounce/Pounce/Presentation/OrangeTabbyShape.swift`
- Create: `pounce/Pounce/Presentation/CatView.swift`
- Create: `pounce/PounceTests/CatViewModelTests.swift`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatViewModelTests`
...
```bash
git add pounce/Pounce/Presentation pounce/PounceTests/CatViewModelTests.swift
...
**Files:**
- Create: `pounce/Pounce/Presentation/ToyOverlayView.swift`
- Create: `pounce/Pounce/Presentation/MenuBarController.swift`
- Create: `pounce/Pounce/Presentation/SettingsView.swift`
- Modify: `pounce/Pounce/PounceApp.swift`

**Interfaces:**
- Consumes: `CatViewModel.handle(_:)`, `PetState`, `PetStateStore`, `PounceWindowController`.
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatViewModelTests/testTreatActionSelectsEatingReaction`
...
```bash
git add pounce/Pounce/PounceApp.swift pounce/Pounce/Presentation pounce/PounceTests/CatViewModelTests.swift
...
**Files:**
- Modify: `pounce/Pounce/PounceApp.swift`
- Modify: `pounce/Pounce/Presentation/CatViewModel.swift`
- Modify: `pounce/Pounce/Desktop/WorkspaceObserver.swift`
- Create: `pounce/README.md`
...
Run: `xcodebuild test -project Pounce.xcodeproj -scheme Pounce -destination 'platform=macOS' -only-testing:PounceTests/CatViewModelTests/testPausedModelDoesNotScheduleNewIdleActivity`
...
```bash
git add pounce/Pounce pounce/PounceTests pounce/README.md
